...
enum {
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC1_GRANULATED_WORKITEM_VGPR_COUNT_SHIFT = 0,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC1_GRANULATED_WORKITEM_VGPR_COUNT_MASK = 0x3Fu,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC1_GRANULATED_WAVEFRONT_SGPR_COUNT_SHIFT = 6,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC1_GRANULATED_WAVEFRONT_SGPR_COUNT_MASK = 0xFu
                                                                           << 6,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC1_WGP_MODE = 1u << 29,
};
...
enum {
  ...
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC2_GFX9_TRAP_HANDLER_ENABLE = 1u << 6,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC2_GFX12_DYNAMIC_VGPR_ENABLE = 1u << 6,
...
enum {
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX90A_THREADGROUP_SPLIT = 1u << 16,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX10_GFX11_SHARED_VGPR_COUNT_MASK = 0xFu,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX12_GROUP_LAUNCH_GUARANTEE_ENABLE = 1u
                                                                          << 13,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX125_NAMED_BARRIER_COUNT_SHIFT = 14,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX125_NAMED_BARRIER_COUNT_MASK = 0x7u
                                                                      << 14,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX125_DYNAMIC_VGPR_ENABLE = 1u << 17,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX125_TCP_SPLIT_SHIFT = 18,
  IREE_HAL_AMDGPU_COMPUTE_PGM_RSRC3_GFX125_TCP_SPLIT_MASK = 0x7u << 18,
};
