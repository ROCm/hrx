...
// epoch and straight-line control flow. Operand-free physical materializations
// share only overlapping same-block lifetimes. Virtual values retain ordinary
// dominance-scoped reuse. Source definitions are handled by the cse pass.
