...
TEST(LowLowerRuleSelectionTest, RanksActionableFailuresBeforeDepth) {
  const loom_low_lower_rule_selection_t diagnostic_failure = {
      .has_source_op_span = true,
      .diagnostic_index = 1,
      .matched_guard_count = 1,
  };
  const loom_low_lower_rule_selection_t structural_nonmatch = {
      .has_source_op_span = true,
...
TEST(LowLowerRuleSelectionTest, UsesCompatibilityThenDepthForEqualFailures) {
  const loom_low_lower_rule_selection_t shallow_failure = {
      .has_source_op_span = true,
      .diagnostic_index = 1,
      .matched_guard_count = 1,
  };
  const loom_low_lower_rule_selection_t deep_failure = {
      .has_source_op_span = true,
      .diagnostic_index = 2,
